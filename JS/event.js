...
function fillEventContainer(){
  ...
  eventList.forEach(event=>{
    ...
    <li class="eventcardA">
      <ul>
        <li><span class="eventcardheading">Event Title:</span> ${event.title}</li>
        <li><span class="eventcardheading">Field:</span> ${event.field}</li>
        <li><span class="eventcardheading">Event Description:</span> ${event.description}</li>
        <li><span class="eventcardheading">Event DeadLine:</span> ${event.date}</li>
      </ul>
    </li>`;
